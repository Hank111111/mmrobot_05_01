...
def preprocess(image_origin):
    image = cv2.resize(image_origin, (200,200))
    return FeatureExtractor.getFeatures(image)
...
#    print val_y_data[1:10], type(val_y_data[1])
...
if __name__ == "__main__":
    ...
    train(dir_name=join(data_dir,"roi_1"),save_dir=save_dir, save_name="train_model_roi_1.m", val_ratio=0.3)  
    train(dir_name=join(data_dir,"roi_2"),save_dir=save_dir, save_name="train_model_roi_2.m", val_ratio=0.3)
    train(dir_name=join(data_dir,"roi_3"),save_dir=save_dir, save_name="train_model_roi_3.m", val_ratio=0.3)      
    train(dir_name=join(data_dir,"roi_4"),save_dir=save_dir, save_name="train_model_roi_4.m", val_ratio=0.3)
